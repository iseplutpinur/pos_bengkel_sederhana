<div class="panel panel-default">
    <div class="panel-heading">
        Cetak Laporan Data Suplier
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                <form action="./page/cetak/cetak.php?laporan=suplier" target="blank" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <table width="100%" onclick="tableCapture()" id="tabel_tabel">
                                <tr>
                                    <td style="white-space:nowrap"><label for="tabel_nama" class="form-check-label">Nama Suplier</label></td>
                                ...
                                <tr>
                                    <td style="white-space:nowrap"><label for="tabel_kode" class="form-check-label">Kode suplier</label></td>
