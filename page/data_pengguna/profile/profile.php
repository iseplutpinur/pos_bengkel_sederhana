        ...
        if (password_verify($_POST['user_password_lama'], $user['user_password'])) {
            ...
            if ($user_password_baru == $user_password_baru1) {
                ...
                if ($koneksi->query($querybuilder)) {
                    ...
                    setAlert('Gagal..! ', mysqli_error($koneksi), 'danger');
                    echo '<script type = "text/javascript">window.location.href = "' . $_baseurl . '";</script>';
                }
            } else $passbaru = false;
        } else $passlama = false;
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <?php if ($passlama) : ?>
                                        <input type="password" class="form-control" id="user_password_lama" name="user_password_lama" placeholder="Password Lama" value="<?php echo $pass['lama']; ?>" required="">
                                    <?php else : ?>
                                        <input type="password" class="form-control is-invalid" id="user_password_lama" name="user_password_lama" placeholder="Password Lama" value="<?php echo $pass['lama']; ?>" required="">
